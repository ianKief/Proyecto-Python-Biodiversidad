...
pg = st.navigation([pagina_inicio, pagina_estado, pagina_busqueda, pagina_visualizacion, pagina_gestion, pagina_datasets, pagina_ficha],position="hidden")

with st.sidebar:
    st.page_link(pagina_inicio)
    st.page_link(pagina_estado)
    st.page_link(pagina_busqueda)
    st.page_link(pagina_visualizacion)
    st.page_link(pagina_gestion)
    st.page_link(pagina_datasets)
